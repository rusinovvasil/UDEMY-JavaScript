...
calculated based on the rules above (you can 
check out the code from the first tip calculator challenge 
...
Create an array called tips containing the tip value 
